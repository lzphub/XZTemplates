package cn.dankal.basiclib.widget.wheelview;/*
...
import cn.dankal.basiclib.widget.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.colorDE));
        // 设置线宽
