...
public class BankUtil {
    ...
    private static final String[] bankName = {
            ...
            "工商银行·牡丹VISA信用卡", "工商银行·牡丹运通卡普通 卡", "工商银行·牡丹VISA信用卡", "工商银行·牡丹VISA白金卡", "工商银行·牡丹贷记卡(银联卡)",
    ...
    // 查找方法
    public static int binarySearch(String cardnumber) {
        String charBin = cardnumber.substring(0, 6);
        int bin = 0;
        bin = Integer.valueOf(charBin);
        int low = 0;
        int high = bankBin.length;
        while (low < high) {
