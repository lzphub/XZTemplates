package cn.xz.basiclib.widget.loadsir.core;
...
import cn.xz.basiclib.widget.loadsir.callback.SuccessCallback;
...
public class LoadService<T> {
    ...
    LoadService(Convertor<T> convertor, TargetContext targetContext, LoadSir.Builder builder) {
        this.convertor = convertor;
        Context context = targetContext.getContext();
        View oldContent = targetContext.getOldContent();
        ViewGroup.LayoutParams oldLayoutParams = oldContent.getLayoutParams();
