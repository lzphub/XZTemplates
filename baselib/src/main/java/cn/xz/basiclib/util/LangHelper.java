...
public class LangHelper {
    ...
    public static String regularizePrice(String price) {
        return String.format(Locale.CHINESE, "%.2f",
                Float.valueOf(StringUtil.safeString(price,"0")));
    }
    public static float regularizePriceF(String price) {
        return Float.valueOf(String.format(Locale.CHINESE, "%.2f",
                Float.valueOf(StringUtil.safeString(price,"0"))));
    }
